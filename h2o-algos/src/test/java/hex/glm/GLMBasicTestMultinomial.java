...
//      params._lambda_search = true;
  ...
  public void testMultinomialADMMSpeedUp(){
    ...
    try {
      ...
      checkADMM(fr, 0,0, true, Solver.IRLSM_SPEEDUP);  // check with only enum columns with both
    //  checkADMM(fr, 0,0, true, Solver.IRLSM_SPEEDUP_NO_ADMM);  // check with only enum columns with both
